...
function App() {
  return (
   ...
   <Hero title='Welcome to complaining website' 
         discription='Your platform for submitting and tracking claims with Rwanda Revenue Authority and other government agencies'  
         Button_1_link='claim' 
         Button_1_Name='Submit New Claim' 
         Button_2_link='myclaim' 
         Button_2_Name='Track My Claims'/>
