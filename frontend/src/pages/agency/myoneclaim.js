                      ...
                      <div className="card-body">
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-6">
                            ...
                            <p>TIN Number: {claim.ClaimsUser.tinnumber}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row mt-4">
                      <div className="col-12 text-center">
                        {claim.status === 'pending' && (
                          <>
                            <button onClick={() => handleApprove(claim.id)} className="btn btn-success me-2">Approve</button>
                            <button onClick={() => handleReject(claim.id)} className="btn btn-danger">Reject</button>
                          </>
                        )}
